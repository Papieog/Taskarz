...
private: System::Void Dodaj_B_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (dodajForm.ShowDialog() == System::Windows::Forms::DialogResult::OK) {
		...
		if (!String::IsNullOrEmpty(taskTitle)) {DodajTask(taskTitle, selectedTab, opis, termin, false);}
	}
}
...
*@brief Dodaje taska
*/
private: System::Void DodajTask(String^ text, TabPage^ selectedTab, String^ opis, DateTime^ termin, bool zakonczone) {
...
private: System::Void usun_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (selectedTab != nullptr) {
		...
		Popraw_puste_poz(selectedTab);
	}
}
/*
*@brief Naprawia kolejnosc taskow
*/
private: System::Void Popraw_puste_poz(TabPage^ tab) {
...
private: System::Void zakoncz_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (selectedTab != nullptr) {
		...
		Popraw_puste_poz(tabPage1);
		Popraw_puste_poz(tabPage2);
		Popraw_puste_poz(tabPage3);
	}
}
/*
*@brief Zapisuje taski do pliku tekstowego
*/
private: System::Void ZapiszDoPliku(String^ filePath) {
...
private: System::Void zapisz_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (saveFileDialog->ShowDialog() == System::Windows::Forms::DialogResult::OK) {
		ZapiszDoPliku(saveFileDialog->FileName);
	}
}
/*
    ...
    if (openFileDialog->ShowDialog() == System::Windows::Forms::DialogResult::OK) {
        ...
        for each (String ^ line in lines) {
            ...
            if (values->Length == 4) {
				...
				DodajTask(title, selectedTab, description, termin, isFinished);
			}
		}
	}
}
